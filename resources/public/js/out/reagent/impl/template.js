...
var G__3913 = o;
goog.object.set(G__3913,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__3917 = o;
goog.object.set(G__3917,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__3918__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__3918 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__3919__i = 0, G__3919__a = new Array(arguments.length -  0);
while (G__3919__i < G__3919__a.length) {G__3919__a[G__3919__i] = arguments[G__3919__i + 0]; ++G__3919__i;}
  args = new cljs.core.IndexedSeq(G__3919__a,0,null);
} 
return G__3918__delegate.call(this,args);};
G__3918.cljs$lang$maxFixedArity = 0;
G__3918.cljs$lang$applyTo = (function (arglist__3920){
var args = cljs.core.seq(arglist__3920);
return G__3918__delegate(args);
});
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__3921__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__3922 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__3922,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__3922;
}
})(),id_class);
...
var G__3923 = (cljs.core.count(argv) - first_child);
switch (G__3923) {
case (0):
...
break;
case (1):
var G__3924 = component;
var G__3925 = jsprops;
var G__3926 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__3924,G__3925,G__3926);
...
var vec__3928 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3928,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3928,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3928,(2),null);
...
var temp__5739__auto___3931 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___3931 == null)){
} else {
var key_3932 = temp__5739__auto___3931;
(jsprops.key = key_3932);
}
...
var temp__5739__auto___3935 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___3935 == null)){
} else {
var key_3936 = temp__5739__auto___3935;
(jsprops.key = key_3936);
}

var G__3933 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__3934 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__3933,G__3934);
});
/**
...
var temp__5739__auto___3937 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___3937 == null)){
} else {
var key_3938 = temp__5739__auto___3937;
(jsprops.key = key_3938);
}
...
var temp__5739__auto___3939 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___3939 == null)){
} else {
var key_3940 = temp__5739__auto___3939;
(jsprops.key = key_3940);
}
...
var temp__5739__auto___3941 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___3941 == null)){
} else {
var key_3942 = temp__5739__auto___3941;
(jsprops.key = key_3942);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__3943_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__3943_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__3944 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3944,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3944,(1),null);
...
var G__3951 = tag;
var G__3951__$1 = (((G__3951 instanceof cljs.core.Keyword))?G__3951.fqn:null);
switch (G__3951__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template3954 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template3954 = (function (opts,id,fn_to_element,meta3955){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template3954.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_3956,meta3955__$1){
var self__ = this;
var _3956__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template3954(self__.opts,self__.id,self__.fn_to_element,meta3955__$1));
}));

(reagent.impl.template.t_reagent$impl$template3954.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_3956){
var self__ = this;
var _3956__$1 = this;
return self__.meta3955;
}));

(reagent.impl.template.t_reagent$impl$template3954.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template3954.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template3954.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template3954.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template3954.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta3955], null);
}));

(reagent.impl.template.t_reagent$impl$template3954.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template3954.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template3954");

(reagent.impl.template.t_reagent$impl$template3954.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template3954");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template3954.
 */
reagent.impl.template.__GT_t_reagent$impl$template3954 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template3954(opts__$1,id__$1,fn_to_element__$1,meta3955){
return (new reagent.impl.template.t_reagent$impl$template3954(opts__$1,id__$1,fn_to_element__$1,meta3955));
});

}

return (new reagent.impl.template.t_reagent$impl$template3954(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
