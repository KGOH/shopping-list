window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:3000\/figwheel-connect?fwprocess=43a880&fwbuild=dev"};
...
document.write('<script>goog.require("shopping_list.core");</script>');
